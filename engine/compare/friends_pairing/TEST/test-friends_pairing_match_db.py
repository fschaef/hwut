# PURPOSE: 'LineElementDb'
#
# The 'LineElementDb' maintains possible matches between subject and nominal lines.
# 
...
if "analogy_interferences" in sys.argv:
    def test(match_db, analogy_db):
        ...
        match_db_2 = LineElementDb(match_db)
