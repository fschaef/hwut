...
'run as a script?':
    ...
    if __package__ in (None, ""):
        import config; __package__ = config.PACKAGE
...
NOTE: This file imports nothing from vut at module scope until the path
      ...
      config' finds THIS file deterministically.
______________________________________________________________________________
"""
import os
import sys
...
import vut.engine.test_run.services                       # noqa: E402,F401

PACKAGE = "vut.engine.test_run.services"
