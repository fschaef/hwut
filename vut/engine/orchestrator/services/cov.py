...
from ...coverage.record   import parse_record, format_record, RecordFault
from ...coverage.binary   import pack_record, unpack_record, MAGIC
from ...coverage.reader   import registered_tuple, framework_of
from ...coverage.registry import DEFAULT_TOOL_DB
...
def _gather(word_list, write):
    ...
    """
    from ...coverage.gather import (gathered_index, snapshot_db_of,
                                    bundle_of, write_bundle, BUNDLE_FILE)
...
def _stale(word_list, write):
    ...
    """
    from ...coverage.gather import read_bundle, stale_tuple, GatherFault
