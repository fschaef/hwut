...
______________________________________________________________________________
"""
from vut.engine.temporal_logic.luau.luau_fragment import ParseResult


class FakeLuauOracle:
    """In-process stand-in for LuauOracle, for tests.

    Optionally records every wrapped text it was asked to parse, so a test can
    show how many candidates 'find_matching_brace' tried before it settled.
    """
