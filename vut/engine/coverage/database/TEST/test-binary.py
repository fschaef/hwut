...
#  'test-readers.py' moved to 'readers/TEST/' when the component split
#  (session 2026-09-04): its real, witnessed fixtures (COVERAGE_JSON,
#  PROG_GCOV, ...) belong to ONE place, and this file's round-trip
#  wants the SAME artefacts, not a second paste of them. So the
#  sibling directory joins the path rather than the fixtures being
#  duplicated -- 'one law, one place' applied to test data.
