...
from vut.engine.coverage.database.record        import format_record, line_n
from vut.engine.coverage.readers.reader        import framework_of, registered_tuple
...
def test_native():
    ...
    from vut.engine.coverage.database.measure import BRANCH, TOGGLE, COVER
...
def test_psl():
    ...
    from vut.engine.coverage.database.measure import COVER
...
def test_ucis():
    ...
    from vut.engine.coverage.database.measure import BRANCH, TOGGLE
...
def test_roles():
    ...
    from vut.engine.coverage.readers.reader import (CCoverageFramework,
